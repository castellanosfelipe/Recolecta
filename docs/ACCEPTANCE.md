...
163 pruebas aprobadas, autodiagnóstico fuente y congelado aprobados, bundle
`onedir` de 46,5 MB.
...
- [ ] Sin internet ni Python instalado, `install.ps1` activa el dashboard en menos de 60 segundos.
